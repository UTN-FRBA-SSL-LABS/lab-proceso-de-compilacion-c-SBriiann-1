...
> **R: Al procesar <stdio.h> se insertan textualmente en programa.i , por lo que aumentan las lineas**
...
> **R:No lee los comentarios de codigo, su funcion es solo leer el codigo limpio que se compile**
...
> **R:printf("=== Laboratorio de Compilacion en C (v%s) ===\n\n", "1.0");**
...
> **R:Proviene del archivo /usr/include/stdio.h, indican el origen del codigo (Marcadores de posicion)**
...
> **R:Preparan el espacio en la memoria (stack) para que la funcion pueda recibir datos sin romperse nada**
...
> **R:Porque U es de undefined (Indefinido), y en matematica.o es porque es tipo text, ahi esta definida**
...
> **R:Quedan porque son funciones que pertenecen a la biblioteca libc, Lo resuelve el linker dinamico en el momento que ejecutamos el programa**
...
> **R:macro es un reemplazo de texto que ocurre en el preprocesamiento, por lo que desaparece antes de que el compilador analice el codigo, la funcion real tiene verificación de tipos (analisis semantico, compila y resuelve), mientras que la macro no**
...
> **R:El simbolo T presenta codigo ejecutable mientras uno de tipo D representa variables globales**
...
> **R:        linux-vdso.so.1 (0x00007ffd5bfd3000)
        libc.so.6 => /lib/x86_64-linux-gnu/libc.so.6 (0x000073e06f88d000)
        /lib64/ld-linux-x86-64.so.2 (0x000073e06faad000)**

¿Por qué `libc` no hubo que especificarla explícitamente al enlazar con `gcc`?

> **R:gcc la incluye por defecto**
